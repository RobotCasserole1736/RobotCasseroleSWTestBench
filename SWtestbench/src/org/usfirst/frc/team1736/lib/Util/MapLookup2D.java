...
* DESCRIPTION:
* <br>
* A simple way to define an arbitrary function of one input variable with
* linear interpolation between that input and the output. The user defines
* a series of known X/Y points in the function, and then calls lookupVal with
* an arbitrary XVal. This class will return an appropriate Y value by linearly
* interpolating in defined regions, or extending end-point Y values for extreme
* X values.
 */
